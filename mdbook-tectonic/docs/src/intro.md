...
[ci]: https://travis-ci.org/lbeckman314/mdbook-tectonic
[ci-badge]: https://api.travis-ci.org/lbeckman314/mdbook-tectonic.svg?branch=master
...
Then, to install `mdbook-tectonic`, enter the following in a shell:
...
[x86_64-pc-windows-gnu]: https://github.com/lbeckman314/mdbook-tectonic/releases/download/v0.1.24/mdbook-tectonic-v0.1.24-x86_64-unknown-linux-gnu.tar.gz
